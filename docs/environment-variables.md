...
| `TRANSCODE_COMPATIBILITY_CODEC` | The codec used to transcode formats that browsers cannot play. Options: `aac`, `opus`. Forced, FLAC-policy, embed, and Subsonic transcodes use AAC. | `aac` |
